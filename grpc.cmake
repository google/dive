...
add_definitions(-DgRPC_BUILD_CODEGEN=ON
...
if(GRPC_AS_SUBMODULE)
  ...
  if(CMAKE_CROSSCOMPILING)
    ...
    message("_PROTOBUF_PROTOC is " ${_PROTOBUF_PROTOC})
  ...
  if(CMAKE_CROSSCOMPILING)
    ...
    message("_GRPC_CPP_PLUGIN_EXECUTABLE is " ${_GRPC_CPP_PLUGIN_EXECUTABLE})
  else()
...
elseif(GRPC_FETCHCONTENT)
  ...
  # set(_PROTOBUF_PROTOC /usr/local/google/home/renfeng/src/xrlayer/protobuf-build/protoc)
  set(_GRPC_GRPCPP grpc++)
  if(CMAKE_CROSSCOMPILING)
    find_program(_GRPC_CPP_PLUGIN_EXECUTABLE grpc_cpp_plugin PATHS ${CMAKE_SOURCE_DIR}/bin)
  else()
