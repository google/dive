...
TEST(AndroidTraceManagerTest, TraceByFrameSuccessful)
{
    AndroidTraceManager android_trace_manager;
    AndroidTraceManager::TraceByFrameConfig frame_config;

    frame_config.total_frames = 1;
    android_trace_manager.SetFrameConfig(frame_config);

    EXPECT_TRUE(android_trace_manager.IsState(AndroidTraceManager::TraceState::Idle));
    ...
    EXPECT_TRUE(android_trace_manager.IsState(AndroidTraceManager::TraceState::Triggered));

    // We should start tracing on this frame boundary
    android_trace_manager.OnNewFrame();
    EXPECT_EQ(android_trace_manager.GetApplicationFrames(), 2);
    EXPECT_TRUE(android_trace_manager.IsState(AndroidTraceManager::TraceState::Tracing));

    // We should stop tracing on this frame boundary
    android_trace_manager.OnNewFrame();
    EXPECT_EQ(android_trace_manager.GetApplicationFrames(), 3);
    EXPECT_TRUE(android_trace_manager.IsState(AndroidTraceManager::TraceState::Finished));
...
TEST(AndroidTraceManagerTest, TraceByDurationSuccessful)
{
    AndroidTraceManager android_trace_manager;
    AndroidTraceManager::TraceByDurationConfig duration_config;
...
TEST(AndroidTraceManagerTest, TwoFrameTracesInSameSessionSuccessful)
{
    AndroidTraceManager android_trace_manager;
    AndroidTraceManager::TraceByFrameConfig frame_config;
...
TEST(AndroidTraceManagerTest, TwoDurationTracesInSameSessionSuccessful)
{
    AndroidTraceManager android_trace_manager;
    AndroidTraceManager::TraceByDurationConfig duration_config;
...
TEST(AndroidTraceManagerTest, FrameAndDurationTraceInSeparateSessionsSuccessful)
{
    AndroidTraceManager android_trace_manager;
    {
        AndroidTraceManager::TraceByFrameConfig frame_config;
