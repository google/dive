...
{
    auto available_metrics =
        AvailableMetrics::LoadFromCsv(TEST_DATA_DIR "/mock_available_metrics.csv");
    ASSERT_NE(available_metrics, nullptr);

    auto perf_metrics_data = PerfMetricsData::LoadFromCsv(
        TEST_DATA_DIR "/mock_perf_metrics_data.csv", *available_metrics);
    ...
    EXPECT_THAT(
        ...
        ElementsAre(
            ...
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 999, 10001, 1, 1, 1, 7, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(2109), DoubleEq(2.109)))),
            // First complete frame:
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1000, 10000, 1, 1, 1, 4, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(1230), DoubleEq(1.230)))),
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1000, 10000, 2, 1, 1, 5, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(1100), DoubleEq(1.100)))),
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1000, 10000, 3, 1, 1, 6, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
            ...
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1000, 10001, 1, 1, 1, 7, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(2100), DoubleEq(2.100)))),
            // Second complete frame:
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1001, 10000, 1, 1, 1, 4, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(1232), DoubleEq(1.232)))),
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1001, 10000, 2, 1, 1, 5, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(1102), DoubleEq(1.102)))),
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1001, 10000, 3, 1, 1, 6, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
            ...
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1001, 10001, 1, 1, 1, 7, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(2102), DoubleEq(2.102)))),
            // Incomplete frame at the end:
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1002, 10000, 1, 1, 1, 4, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
                        ElementsAre(DoubleEq(1234), DoubleEq(1.234)))),
            AllOf(PerfMetricsRecordEq(PerfMetricsRecord{1, 100, 1002, 10000, 2, 1, 1, 5, 1, {}}),
                  Field(&PerfMetricsRecord::m_metric_values,
...
TEST(PerfMetricsData, LoadFromCsvMalformedRowSkipped)
{
    ...
    auto perf_metrics_data = PerfMetricsData::LoadFromCsv(
        TEST_DATA_DIR "/mock_perf_metrics_data_malformed.csv", *available_metrics);
    ASSERT_NE(perf_metrics_data, nullptr);
    ASSERT_THAT(perf_metrics_data->GetRecords(), SizeIs(1));
    EXPECT_THAT(perf_metrics_data->GetRecords(),
                ElementsAre(AllOf(
                    PerfMetricsRecordEq(PerfMetricsRecord{2, 200, 2000, 20000, 2, 2, 2, 2, 2, {}}),
                    Field(&PerfMetricsRecord::m_metric_values,
...
{
    auto available_metrics =
        AvailableMetrics::LoadFromCsv(TEST_DATA_DIR "/mock_available_metrics_unknown_type.csv");
    ASSERT_NE(available_metrics, nullptr);
...
TEST(PerfMetricsData, LoadFromCsvWrongColumnsSkipped)
{
    ...
    auto perf_metrics_data = PerfMetricsData::LoadFromCsv(
        TEST_DATA_DIR "/mock_perf_metrics_data_wrong_columns.csv", *available_metrics);
...
TEST(PerfMetricsData, LoadFromCsvUnknownMeticTypeSkipped)
{
    ...
    auto perf_metrics_data = PerfMetricsData::LoadFromCsv(
        TEST_DATA_DIR "/mock_perf_metrics_data_unknown_type.csv", *available_metrics);
    ASSERT_EQ(perf_metrics_data, nullptr);
}
...
TEST(PerfMetricsDataProviderTest, GetRecordHeader)
{
    ...
    ASSERT_NE(provider, nullptr);
    ASSERT_THAT(
        provider->GetRecordHeader(),
        ElementsAre("ContextID", "ProcessID", "FrameID", "CmdBufferID", "DrawID", "DrawType",
                    "DrawLabel", "ProgramID", "LRZState", "COUNTER_A", "COUNTER_B"));
}
