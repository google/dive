    ...
    for variant in variant_list:
      ...
      if opcode not in packet_type_instances:
        ...
        if (opcode == 0):
          ...
          pm4_info_file.write("    // They're not technically PM4 packets, hence the 0x0.\n")
          pm4_info_file.write("    // It's used: \"const PacketInfo *packet_info_ptr = GetPacketInfo(0, sharp_struct_name);\".\n")
