...
LookingForDraw::LookingForDraw(StateMachine& parent, gfxrecon::decode::VulkanConsumer& found_end)
    : parent_(parent), found_end_(found_end)
{
}
...
LookingForBeginRenderPass::LookingForBeginRenderPass(StateMachine& parent,
                                                     gfxrecon::decode::VulkanConsumer& found_begin)
    : parent_(parent), found_begin_(found_begin)
{
}
...
LookingForBeginCommandBuffer::LookingForBeginCommandBuffer(
    StateMachine& parent, gfxrecon::decode::VulkanConsumer& found_begin)
    : parent_(parent), found_begin_(found_begin)
{
}
