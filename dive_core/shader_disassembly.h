...
{
 public:
    Disassembly(const IMemoryManager& mem_manager, uint32_t submit_index, uint64_t address,
                ILog* log = nullptr);
...
bool Disassemble(const uint8_t* shader_memory, uint64_t shader_address, size_t shader_size,
