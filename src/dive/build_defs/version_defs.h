...
// This is the location of the device resources folder
// TODO(b/462767957): Remove build_defs DIVE_INSTALL_DIR_PATH
#define DIVE_INSTALL_DIR_PATH CMAKE_GENERATED_INSTALL_DIR_PATH
// This is relative to the device resources folder
