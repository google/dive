...
// This is a copy of gfx9_plus_merged_f32_pfp_pm4_packets.h, but with
...
typedef struct PM4_PFP_ACQUIRE_MEM__GFX09
{
    ...
    union
    {
        struct
        {
            ...
            uint32_t engine_sel : 1;  // PFP_ACQUIRE_MEM_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_ATOMIC_GDS
{
    ...
    union
    {
        struct
        {
            ...
            uint32_t atom_cmp_swap : 1;  // PFP_ATOMIC_GDS_atom_cmp_swap_enum
            uint32_t atom_complete : 1;  // PFP_ATOMIC_GDS_atom_complete_enum
            uint32_t atom_read : 1;      // PFP_ATOMIC_GDS_atom_read_enum
            uint32_t atom_rd_cntl : 2;   // PFP_ATOMIC_GDS_atom_rd_cntl_enum
            uint32_t reserved2 : 9;
            uint32_t engine_sel : 2;  // PFP_ATOMIC_GDS_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_ATOMIC_MEM
{
    ...
    union
    {
        struct
        {
            ...
            uint32_t command : 4;  // PFP_ATOMIC_MEM_command_enum
            uint32_t reserved2 : 13;
            uint32_t cache_policy : 2;  // PFP_ATOMIC_MEM_cache_policy_enum
            uint32_t reserved3 : 3;
            uint32_t engine_sel : 2;  // PFP_ATOMIC_MEM_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_CLEAR_STATE
{
    ...
    union
    {
        struct
        {
            uint32_t cmd : 4;  // PFP_CLEAR_STATE_cmd_enum
...
typedef struct PM4_PFP_COND_INDIRECT_BUFFER
{
    ...
    union
    {
        struct
        {
            uint32_t mode : 2;  // PFP_COND_INDIRECT_BUFFER_mode_enum
            uint32_t reserved1 : 6;
            uint32_t function : 3;  // PFP_COND_INDIRECT_BUFFER_function_enum
    ...
    union
    {
        struct
        {
            ...
            uint32_t reserved1 : 8;
            uint32_t cache_policy1 : 2;  // PFP_COND_INDIRECT_BUFFER_cache_policy1_enum
    ...
    union
    {
        struct
        {
            ...
            uint32_t reserved1 : 8;
            uint32_t cache_policy2 : 2;  // PFP_COND_INDIRECT_BUFFER_cache_policy2_enum
            uint32_t reserved2 : 2;
        } bitfields14;
        uint32_t ordinal14;
    };
...
typedef struct PM4_PFP_COPY_DATA
{
    ...
    union
    {
        struct
        {
            uint32_t src_sel : 4;  // PFP_COPY_DATA_src_sel_enum
            uint32_t reserved1 : 4;
            uint32_t dst_sel : 4;  // PFP_COPY_DATA_dst_sel_enum
            uint32_t reserved2 : 1;
            uint32_t src_cache_policy : 2;  // PFP_COPY_DATA_src_cache_policy_enum
            uint32_t reserved3 : 1;
            uint32_t count_sel : 1;  // PFP_COPY_DATA_count_sel_enum
            uint32_t reserved4 : 3;
            uint32_t wr_confirm : 1;  // PFP_COPY_DATA_wr_confirm_enum
            uint32_t reserved5 : 4;
            uint32_t dst_cache_policy : 2;  // PFP_COPY_DATA_dst_cache_policy_enum
            uint32_t reserved6 : 3;
            uint32_t engine_sel : 2;  // PFP_COPY_DATA_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_DISPATCH_DRAW_PREAMBLE
{
    ...
    union
    {
        struct
        {
            ...
            uint32_t not_eop : 1;          // PFP_DISPATCH_DRAW_PREAMBLE_not_eop_enum
            uint32_t req_path__GFX09 : 1;  // PFP_DISPATCH_DRAW_PREAMBLE_req_path_enum
...
typedef struct PM4_PFP_DMA_DATA
{
    ...
    union
    {
        struct
        {
            uint32_t engine_sel : 1;  // PFP_DMA_DATA_engine_sel_enum
            uint32_t reserved1 : 12;
            uint32_t src_cache_policy : 2;  // PFP_DMA_DATA_src_cache_policy_enum
            uint32_t reserved2 : 5;
            uint32_t dst_sel : 2;  // PFP_DMA_DATA_dst_sel_enum
            uint32_t reserved3 : 3;
            uint32_t dst_cache_policy : 2;  // PFP_DMA_DATA_dst_cache_policy_enum
            uint32_t reserved4 : 2;
            uint32_t src_sel : 2;  // PFP_DMA_DATA_src_sel_enum
            uint32_t cp_sync : 1;
        } bitfields2;
        uint32_t ordinal2;
    };
    ...
    union
    {
        struct
        {
            ...
            uint32_t sas : 1;   // PFP_DMA_DATA_sas_enum
            uint32_t das : 1;   // PFP_DMA_DATA_das_enum
            uint32_t saic : 1;  // PFP_DMA_DATA_saic_enum
            uint32_t daic : 1;  // PFP_DMA_DATA_daic_enum
            uint32_t raw_wait : 1;
            uint32_t dis_wc : 1;
        } bitfields7;
        uint32_t ordinal7;
...
typedef struct PM4_PFP_DMA_DATA_FILL_MULTI
{
    ...
    union
    {
        struct
        {
            uint32_t engine_sel : 1;  // PFP_DMA_DATA_FILL_MULTI_engine_sel_enum
            uint32_t reserved1 : 9;
            uint32_t memlog_clear : 1;
            uint32_t reserved2 : 9;
            uint32_t dst_sel : 2;  // PFP_DMA_DATA_FILL_MULTI_dst_sel_enum
            uint32_t reserved3 : 3;
            uint32_t dst_cache_policy : 2;  // PFP_DMA_DATA_FILL_MULTI_dst_cache_policy_enum
            uint32_t reserved4 : 2;
            uint32_t src_sel : 2;  // PFP_DMA_DATA_FILL_MULTI_src_sel_enum
            uint32_t cp_sync : 1;
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_FRAME_CONTROL
{
    ...
    union
    {
        struct
        {
            uint32_t tmz : 1;  // PFP_FRAME_CONTROL_tmz_enum
            uint32_t reserved1 : 27;
            uint32_t command : 4;  // PFP_FRAME_CONTROL_command_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_INDIRECT_BUFFER
{
    ...
    union
    {
        struct
        {
            ...
            uint32_t reserved1 : 2;
            uint32_t vmid : 4;
            uint32_t cache_policy : 2;  // PFP_INDIRECT_BUFFER_cache_policy_enum
...
typedef struct PM4_PFP_LOAD_CONTEXT_REG_INDEX
{
    ...
    union
    {
        struct
        {
            uint32_t index : 1;  // PFP_LOAD_CONTEXT_REG_INDEX_index_enum
            uint32_t reserved1 : 1;
    ...
    union
    {
        struct
        {
            ...
            uint32_t data_format : 1;  // PFP_LOAD_CONTEXT_REG_INDEX_data_format_enum
        } bitfields4;
        uint32_t ordinal4;
    };
...
typedef struct PM4_PFP_LOAD_SH_REG_INDEX
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 15;
            uint32_t data_format : 1;  // PFP_LOAD_SH_REG_INDEX_data_format_enum
        } bitfields4;
        uint32_t ordinal4;
    };
...
typedef struct PM4_PFP_PREAMBLE_CNTL
{
    ...
    union
    {
        ...
        {
            uint32_t reserved1 : 28;
            uint32_t command : 4;  // PFP_PREAMBLE_CNTL_command_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_PRIME_UTCL2
{
    ...
    union
    {
        struct
        {
            uint32_t cache_perm : 3;  // PFP_PRIME_UTCL2_cache_perm_enum
            uint32_t prime_mode : 1;  // PFP_PRIME_UTCL2_prime_mode_enum
            uint32_t reserved1 : 26;
            uint32_t engine_sel : 2;  // PFP_PRIME_UTCL2_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_BASE
{
    ...
    union
    {
        struct
        {
            uint32_t base_index : 4;  // PFP_SET_BASE_base_index_enum
            uint32_t reserved1 : 28;
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_CONTEXT_REG
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 12;
            uint32_t index__GFX09 : 4;  // PFP_SET_CONTEXT_REG_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_CONTEXT_REG_INDEX__GFX09
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 12;
            uint32_t index : 4;  // PFP_SET_CONTEXT_REG_INDEX_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_PREDICATION
{
    ...
    union
    {
        ...
        {
            uint32_t reserved1 : 8;
            uint32_t pred_bool : 1;  // PFP_SET_PREDICATION_pred_bool_enum
            uint32_t reserved2 : 3;
            uint32_t hint : 1;  // PFP_SET_PREDICATION_hint_enum
            uint32_t reserved3 : 3;
            uint32_t pred_op : 3;  // PFP_SET_PREDICATION_pred_op_enum
            uint32_t reserved4 : 12;
            uint32_t continue_bit : 1;  // PFP_SET_PREDICATION_continue_bit_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_SH_REG_INDEX
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 12;
            uint32_t index : 4;  // PFP_SET_SH_REG_INDEX_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_SH_REG_OFFSET
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 14;
            uint32_t index : 2;  // PFP_SET_SH_REG_OFFSET_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_UCONFIG_REG
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 12;
            uint32_t index__GFX09 : 4;  // PFP_SET_UCONFIG_REG_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_SET_UCONFIG_REG_INDEX
{
    ...
    union
    {
        struct
        {
            uint32_t reg_offset : 16;
            uint32_t reserved1 : 12;
            uint32_t index : 4;  // PFP_SET_UCONFIG_REG_INDEX_index_enum
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_STRMOUT_BUFFER_UPDATE
{
    ...
    union
    {
        struct
        {
            uint32_t update_memory : 1;  // PFP_STRMOUT_BUFFER_UPDATE_update_memory_enum
            uint32_t source_select : 2;  // PFP_STRMOUT_BUFFER_UPDATE_source_select_enum
            uint32_t reserved1 : 4;
            uint32_t data_type : 1;      // PFP_STRMOUT_BUFFER_UPDATE_data_type_enum
            uint32_t buffer_select : 2;  // PFP_STRMOUT_BUFFER_UPDATE_buffer_select_enum
...
typedef struct PM4_PFP_WAIT_REG_MEM
{
    ...
    union
    {
        struct
        {
            uint32_t function : 3;  // PFP_WAIT_REG_MEM_function_enum
            uint32_t reserved1 : 1;
            uint32_t mem_space : 2;   // PFP_WAIT_REG_MEM_mem_space_enum
            uint32_t operation : 2;   // PFP_WAIT_REG_MEM_operation_enum
            uint32_t engine_sel : 2;  // PFP_WAIT_REG_MEM_engine_sel_enum
...
typedef struct PM4_PFP_WAIT_REG_MEM64
{
    ...
    union
    {
        struct
        {
            uint32_t function : 3;  // PFP_WAIT_REG_MEM64_function_enum
            uint32_t reserved1 : 1;
            uint32_t mem_space : 2;   // PFP_WAIT_REG_MEM64_mem_space_enum
            uint32_t operation : 2;   // PFP_WAIT_REG_MEM64_operation_enum
            uint32_t engine_sel : 2;  // PFP_WAIT_REG_MEM64_engine_sel_enum
            uint32_t reserved2 : 15;
        } bitfields2;
        uint32_t ordinal2;
    };
...
typedef struct PM4_PFP_WRITE_DATA
{
    ...
    union
    {
        ...
        {
            uint32_t reserved1 : 8;
            uint32_t dst_sel : 4;  // PFP_WRITE_DATA_dst_sel_enum
            uint32_t reserved2 : 4;
            uint32_t addr_incr : 1;  // PFP_WRITE_DATA_addr_incr_enum
            uint32_t reserved3 : 2;
            uint32_t resume_vf : 1;
            uint32_t wr_confirm : 1;  // PFP_WRITE_DATA_wr_confirm_enum
            uint32_t reserved4 : 4;
            uint32_t cache_policy : 2;  // PFP_WRITE_DATA_cache_policy_enum
            uint32_t reserved5 : 3;
            uint32_t engine_sel : 2;  // PFP_WRITE_DATA_engine_sel_enum
        } bitfields2;
        uint32_t ordinal2;
    };
