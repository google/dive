...
absl::Status InitializeCrashpad()
{
    ...
    database = crashpad::CrashReportDatabase::Initialize(base::FilePath(database_path.native()));
    ...
    {
        return absl::InternalError(absl::StrCat("Crashpad version string '",
                                                version,
                                                "' (",
                                                version.size(),
                                                ") is too long, max is ",
    ...
    std::map<std::string, std::string> annotations = { { "product", kProductName },
                                                       { "format", kFormat },
                                                       { "version", version } };
