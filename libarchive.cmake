...
# Run the build script for libarchive
    ...
    set(ZLIB_ROOT  ${THIRDPARTY_DIRECTORY}/grpc/third_party/zlib)
        ...
        # include_directories("${ZLIB_ROOT}")
        # add_compile_definitions(ZLIB_LIBRARY=${CMAKE_SOURCE_DIR}/prebuild/grpc/lib/zlibstatic.lib)
        # add_compile_definitions(ZLIB_INCLUDE_DIR=${THIRDPARTY_DIRECTORY}/grpc/third_party/zlib)
